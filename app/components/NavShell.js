...
const NAV_ITEMS = [
  ...
  { id: "communities", label: "Communities", href: "/communities", icon: Users, available: false },
  { id: "favorites", label: "Favorites", href: "/favorites", icon: Heart, available: false },
  { id: "history", label: "History", href: "/history", icon: History, available: false },
  { id: "collections", label: "Collections", href: "/collections", icon: FolderOpen, available: false },
  { id: "notifications", label: "Notifications", href: "/notifications", icon: Bell, available: false },
